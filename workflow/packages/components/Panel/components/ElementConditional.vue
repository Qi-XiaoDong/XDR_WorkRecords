...
export default {
  ...
  methods: {
    ...
    getElementConditionType() {
      ...
      this.conditionData.conditionType === "expression" &&
        this.getConditionExpression();
      this.conditionData.conditionType === "script" &&
        this.getConditionScript();
    },
    getConditionExpression() {
      this.conditionData.expression = CU.getConditionExpressionValue(
        getActive()
      );
    },
    getConditionScript() {
      this.conditionData.language = CU.getConditionScriptLanguageValue(
        getActive()
      );
      this.conditionData.scriptType = CU.getConditionScriptTypeValue(
        getActive()
      );
      this.conditionData.body = CU.getConditionScriptBodyValue(getActive());
      this.conditionData.resource = CU.getConditionScriptResourceValue(
        getActive()
      );
    },
